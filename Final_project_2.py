...
st.markdown(
    "<div class='sub-title'>An interactive Machine Learning system forecasting precipitation intervals for Abuja, Nigeria. \n <div class='about-box'> This intelligent web application serves as a Machine Learning Capstone Project designed to forecast precipitation events specifically within Abuja, Nigeria. By establishing a real-time data pipeline with the Open-Meteo Archive API, the system dynamically harvests three full years of historical regional weather parameters. An advanced Random Forest Classifier trains on the fly to accurately map complex atmospheric behaviors against Abuja's distinct wet and dry seasonal cycles. Users can effortlessly input any target calendar date to receive instant, data-driven binary classifications accompanied by mathematical probability metrics. Ultimately, this project highlights how modern cloud-deployed AI frameworks can successfully democratize access to localized predictive meteorology.</div></div>",
    unsafe_allow_html=True)
